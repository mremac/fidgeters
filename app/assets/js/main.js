	...
	function openNav(e) {
	  ...
	  return;
		...
		if(this.id != "hiddenshowcase" && this.id != "null"){
			...
			$('#hiddenshowcase').children('p.info').html(" The " + fidg.id + " is available in 3 colours. Select your colour and shipping region to proceed. Cost: £10 + postage <br><br> Shipping estimates:<br> 3-6 working days inside the UK<br> Up to 15 working days outside UK<br> Up to 30 days for AUS/NZ");
